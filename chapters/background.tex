...
%any practical approach will find it easier proving that a behavior holds for \emph{all} possible executions rather than that it holds for \emph{some}.
%\footnote{This claim might seem counter-intuitive at first, but it is not baseless. Proving a behavior for all possible executions is more restrictive than doing so for some, hence }
