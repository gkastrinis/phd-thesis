...
\titleparagraph{Baseline intra-procedural resoning.}
...
\titleparagraph{Inter-procedural elements.}
...
\titleparagraph{Control-flow merging.}
...
\titleparagraph{Heap manipulation.}
...
\titleparagraph{Alloc, Move, Load, Store-1.} The first four rules of the
...
\titleparagraph{Store-2.} The \textsc{Store-2} rule is the first one
...
\titleparagraph{Frame-1, Frame-2, Frame-3.}
...
%%% SPACE
%% \titleparagraph{Stratification and two-stage analysis.}
...
\titleparagraph{Expanding the Analysis Reach.}
...
\begin{itemize}
\item 
%\titleparagraph{More liberal control-flow merging.}
...
%% \titleparagraph{Why access-path-points-to?}
...
%\titleparagraph{Scalability caveats.}
...
\titleparagraph{Coverage.}  Figure~\ref{fig:coverage} shows the coverage
...
\titleparagraph{Comparison with intra-procedural.}
...
\titleparagraph{Client analysis: devirtualization.}
...
\titleparagraph{Concurrency model.}
...
\titleparagraph{Points-to set sizes.}
...
%% \titleparagraph{Initializing the analysis.}
...
%% \titleparagraph{Object allocation.} The 
...
%% \titleparagraph{Variable moves.} \relname{Move} instructions
...
%% \titleparagraph{Heap loads.} Similarly, heap loads produce over-approximate
...
%% \titleparagraph{Heap stores.} The next two rules handle writes to the heap
%% (store instructions).
...
%% \titleparagraph{Control-flow predecessors.} 
...
%% \titleparagraph{Frame rules: before an instruction to after it.}
...
%% \titleparagraph{Inter-procedural analysis: Over-approximate call-graph.}
...
%% \titleparagraph{Inter-procedural propagation of values: caller-to-callee.}
...
%% \titleparagraph{Inter-procedural propagation of values: callee-to-caller.}
...
\titleparagraph{Observation: implicit over-approximation.}
...
\titleparagraph{Difficulty: non-monotonicity.} The first practical
...
\titleparagraph{Difficulty: capturing all opaque entry points and their
...
\titleparagraph{Difficulty: wasting most work.} A sound points-to analysis
