...
\rel{InterProcAssign}{to, calleeCtx, from, callerCtx} \dlIf{} \\
    \rel{CallGraph}{invo, callerCtx, meth, calleeCtx}, \\
    \rel{FormalArg}{meth, i, to}, \rel{ActualArg}{invo, i, from}. \\
\\
\rel{InterProcAssign}{to, callerCtx, from, calleeCtx} \dlIf{} \\
    \rel{CallGraph}{invo, callerCtx, meth, calleeCtx}, \\
    \rel{FormalReturn}{meth, from}, \rel{ActualReturn}{invo, to}. \\
%
...
\rel{CallGraph}{invo, callerCtx, toMeth, ?calleeCtx} \dlIf{} \\
