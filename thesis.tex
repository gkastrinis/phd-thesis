...
\keywordsGr{Ανάλυση Δεικτών, Αντικειμενοστρεφής Προγραμματισμός, Ακρίβεια, Απόδοση}
\keywordsEn{Pointer Analysis; Object-Oriented Programming; Precision; Performance; Context-Sensitivity}
